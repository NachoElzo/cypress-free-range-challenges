...
describe("Validating inputs valaues from the form page", () => {
  ...
  it.skip("Users can successfully submit the form with only mandatory fields filled", () => {
    formChallenge.fillMandatoryFields(formValues.mandatory);
    formChallenge.verifyFormSubmission();
  });
  it.skip("Users can successfully submit the form when all fields are filled", () => {
    formChallenge.fillMandatoryFields(formValues.mandatory);
